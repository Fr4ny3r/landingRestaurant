      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <nav>
          <ul className="flex space-x-4">
            ...
            <li><a href="#menu" className="text-[var(--color-text)] gap-1 text-sm flex flex-col justify-center items-center hover:text-[var(--color-secondary)]">
            ...
            <li><a href="#contact" className="text-[var(--color-text)] gap-1 text-sm flex flex-col justify-center items-center hover:text-[var(--color-secondary)]">
