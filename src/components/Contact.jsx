...
function Contact() {
  ...
  return (
    <section id="location" className="relative rounded-none md:rounded-xl p-20 bg-[var(--color-card-background)] md:mb-50 z-100 max-h-[600px] container mx-auto text-left">
